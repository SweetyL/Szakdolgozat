    ...
    isset($_POST['webpage']) and isset($_POST['username']) and isset($_POST['password']))) {
        ...
        if ($conn->query($sql)) {
            if (!($result->num_rows > 0)) {
                $sql2 = "INSERT INTO `companies`(`name`, `townID`, `street`, `houseNumber`, `email`, `phoneNumber`, `webpage`, `username`, `password`) VALUES ('".$_POST['companyname']."','".$_POST['town']."','".$_POST['street']."','".$_POST['houseNumber']."','".$_POST['email']."','".$_POST['phoneNumber']."','".$_POST['webpage']."','".$_POST['username']."',MD5('".$_POST['password']."'));";
